...
\title{Kalray kv3 V1 VLIW Core Architecture Manual}
...
\newpage
\input{kv3-v1-ArchitecturalState}

\newpage
\input{kv3-v1-SystemControl}

\newpage
\input{kv3-v1-MemoryManagementUnit}

\newpage
\input{kv3-v1-IntegratedPeripherals}
