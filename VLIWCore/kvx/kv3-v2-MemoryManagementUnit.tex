...
The memory space is globally considered as unprotected (as if PA2 = 13: {RWX, RWX}). All addresses are considered as in Device space (CP2 = 8, implying no misalignment is allowed) except five pre-defined regions that are treated as fully cached (CP2 = 7). These five regions are:
\begin{itemize}
\item The 0x00\_0000\_0000 to 0x00\_007F\_FFFF range (= 0  MB to 8 MB = "local SMEM")
\item The 0x00\_0100\_0000 to 0x00\_017F\_FFFF range (= 16 MB to 24 MB = "cluster 0 SMEM")
\item The 0x00\_0200\_0000 to 0x00\_027F\_FFFF range (= 32 MB to 40 MB = "cluster 1 SMEM")
\item The 0x00\_0300\_0000 to 0x00\_037F\_FFFF range (= 48 MB to 56 MB = "cluster 2 SMEM")
\item The 0x00\_0400\_0000 to 0x00\_047F\_FFFF range (= 64 MB to 72 MB = "cluster 3 SMEM")
\item The 0x00\_0500\_0000 to 0x00\_057F\_FFFF range (= 80 MB to 88 MB = "cluster 4 SMEM")
\item The 0x00\_00D2\_4000 to 0x00\_00D2\_BFFF range (= 32 kB wide, starting at OTP Boot Rom start address)
...
\item The above memory ranges plus 256GB, 512GB and 768GB (other MPPA in a multi-chip configuration, or the same MPPA through RaW checker)
\end{itemize}
